...
def update_output(n_clicks, value):
    ...
    print(1)
    sh = gc.open_by_key('1U2tc5RK94ctkRGPHfP_Yl0WNZglKypt-y7kvDNXLRB8')
    print(2)
    worksheet1 = sh.worksheet('title', 'pwa')
    print(3)
    worksheet1.append_table(values=['n_clicks',n_clicks,'value',value])

    print('2____n_clicks= ', n_clicks, '   value= ', value)
