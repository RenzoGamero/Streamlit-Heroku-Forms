...
def expanderrr(x, q, op, tipo, Dependencia, nivel, vista, DependenciaSiNo, Validar, Dependencia_Respuesta):
    ...
    if tipo == 'hora':
        ...
        if DependenciaSiNo == '' and Dependencia_Respuesta == '':
            ...
            hora =st.time_input(q, key='hora 1' + str(q), value=dt.time(9,0))
    ...
    if tipo == 'Ipress_Metadata':
        ...
        if vista != 'No':
            ...
            print('DFMetadata= ', DFMetadata)
            print('DFMetadata.columns= ', DFMetadata.columns)
            print(    dff1['op'].values[0][0])
            ...
            print('dff1[op].values[0][0]= ', dff1['op'].values[0][0])
            #df['resp'][x] =dfDFMetadataCopy[dff1['op'].values[0][0]].values[0]
            df['resp'][x] =str(dfDFMetadataCopy[op].values[0][0])
    ...
    if tipo == 'Car_Metadata':
        ...
        if vista != 'No':
            ...
            print( 'respuesta__ ',    dfDFMetadataCopy[dff1['op'].values[0][0]].values[0])
            print( 'respuesta__2 ',    dfDFMetadataCopy[op].values[0])
    if tipo == 'Monitor_Metadata':
        DFMetadata = CargaMetadata('Monitor_Metadata')
        if vista != 'No':
            print('Comisarias_Metadata-================')
            print('op= ', op)
...
def expanderrr3(x, q, op, tipo, Dependencia, nivel, vista, DependenciaSiNo, Validar, Dependencia_Respuesta):
    print('=============================================================')
    print('1X= ', x)
    print('1q= ', q)
    print('1nivel= ', nivel)
    ...
    if tipo == 'Car_Metadata':
        ...
        if vista != 'No':
            ...
            print('dff1[op].values[0][0]= ', dff1['op'].values[0][0])
            #df['resp'][x] =dfDFMetadataCopy[dff1['op'].values[0][0]].values[0]
            df['resp'][x] =dfDFMetadataCopy[op].values[0][0]
...
def CargaMetadata(n):
    ...
    if (n == 'Car_Metadata'):
        ...
        print(DFMetadata.head())
        return DFMetadata
    if (n == 'Monitor_Metadata'):
        gc = pygsheets.authorize(service_file='client_secrets.json')
        sh = gc.open_by_key('1TbH3Z3HunRqv1Vj1irfnAPGxRU-GvtjEJAUn2y4J5yo')
        worksheet1 = sh.worksheet('title', 'BD')
